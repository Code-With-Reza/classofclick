...
const modalContent = {
  ...
  8: {
    ...
    body: `
      <p><strong>Enter Dev Mode (Space):</strong> Beralih ke mode pengembangan. Mode khusus untuk developer untuk memeriksa detail desain dengan mudah dan menerjemahkannya menjadi kode.</p>
    `,
  },
};
